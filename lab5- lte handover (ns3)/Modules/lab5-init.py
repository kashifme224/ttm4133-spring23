...
while True:
    print("Do you want to enable X2 based Handovers? (yes OR no OR y OR n OR Y OR N)")
    t11 = input()
    # t11 = 'yes'
    if t11 == 'yes':
        enableX2 = True
...
if enableX2 == True:
    print("X2 will be enabled allowing HOs...")
        
if enableX2 == False:
    print("X2 will be disabled blocking HOs...")
...
res_path = 'results-rsrp' + '-' + ''.join(json_data["name"]) + '-' + str(txpower) + '-' + str(runid)                                # result path for naming outstreams
